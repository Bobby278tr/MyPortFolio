...
const Projects = ({openModal,setOpenModal}) => {
  ...
  return (
    <Container id='projects'>
        ...
        <Description>There are wide range of projects on which I have worked on. Below are some of them. </Description>
        <ToggleGroup>
            { toggle === 'all' ? (
           ...
           <Divider/>
           { toggle === 'api app' ? (
            <ToggleButton active onClick={() => setToggle("api app")}>API APP'S</ToggleButton>
           ):(
            <ToggleButton onClick={() => setToggle("api app")}>API APP'S</ToggleButton>
           )}
        </ToggleGroup>
        <CardContainer>
